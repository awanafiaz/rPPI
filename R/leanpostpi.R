...
#  INPUTS:  None
#
#  OUTPUS:  'Lean' Post-prediction inference function (leanpostpi)
#
...
#' dat <- simdat()
#'
#' leanpostpi(rec_form, inf_form, dat = dat)
#'
#' @export
#'
#' @import stats

leanpostpi <- function(rec_form, inf_form, dat,
