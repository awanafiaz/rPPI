...
#'
#' plusplus_quantile_est(Y_l, f_l, f_u, q = 0.5)
#'
#' @export

plusplus_quantile_est <- function(Y_l, f_l, f_u, q, exact_grid = FALSE,
...
#' f_u <- dat[dat$set == "val", all.vars(form)[2]] |> matrix(ncol = 1)
#'
#' plusplus_quantile(Y_l, f_l, f_u, q = 0.5)
#'
#' @export

plusplus_quantile <- function(Y_l, f_l, f_u, q, alpha = 0.05,
