...
#' PPI Linear Regression using Wang et al. (2020) Multiple Imputation
#'
#' @description
#' A short description...
#'
...
#' m <- 100
#'
#' wang_mi(rel_form, inf_form, dat = dat, m)
#'
#' @export
#'
#' @import stats
...
#-- WANG - MULTIPLE IMPUTATION

wang_mi <- function(rel_form, inf_form, dat, m = 100, rel_func = "lm",
