...
#' N <- nrow(X_u)
#'
#' plusplus_ols_est(X_l, Y_l, f_l, X_u, f_u, n, p, N)
#'
#' @import stats
#'
#' @export

plusplus_ols_est <- function(X_l, Y_l, f_l, X_u, f_u, n, p, N,
...
#' N <- nrow(X_u)
#'
#' plusplus_ols(X_l, Y_l, f_l, X_u, f_u, n, p, N)
#'
#' @import stats
#'
#' @export

plusplus_ols <- function(X_l, Y_l, f_l, X_u, f_u, n, p, N,
  ...
  if (is.null(lhat)) {
    ...
    return(plusplus_ols(X_l, Y_l, f_l, X_u, f_u, n, p, N,
